...
public class TestSearch extends TestCase {
	...
	public void testSearch() throws IOException {
		...
		/**
		 * public SearchResult search(String sessionToken, String
		 * query, String indexLanguage, String queryLanguage, int maxHits,
		 * String templateName, String[] templateFields) throws Exception {
		 */
		try {
			// Get session token 
			String sessionToken = client.login("admin", "admin");
			
			SearchResult sr = client.search(sessionToken, query, "", "it", 20, null, null);
