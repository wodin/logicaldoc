...
public class ZABWParserTest extends TestCase  {
	
	private String myContent;

	
	public void testParseZABWFolder() throws IOException {

		File dir = new File("C:/tmp/abiword");
		
		String[] files = dir.list(new SuffixFileFilter(".zabw"));
	...
	private void parseFile(File dir, String fileName) throws IOException {
		...
		AbstractParser parser = new ZABWParser();
		parser.parse(file);
