...
public class DateBean extends Date {
     ...
     */
    public static String toCompactString(String date, String lang) {
        return toCompactString(date, LocaleInformation.getDateFormat(lang), lang);
    }
    ...
    /**
     * This method formats a compact date (yyyyMMdd) to a localised date.
     * 
     * @param date string containing the date to be converted
     * @param lang to which language it should be converted to
     * @return a string containing the converted date
     */
    public static String toLocaleString(String date, String lang) {
        if ((date != null) && !date.equals("")) {
            return convertDate("yyyyMMdd HHmmss", LocaleInformation.getDateFormat(lang), date);
        } else {
            return "";
        }
    }
