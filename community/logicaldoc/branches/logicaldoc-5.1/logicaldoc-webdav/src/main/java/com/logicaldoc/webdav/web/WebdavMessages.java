...
public class WebdavMessages extends AbstractMap<String, String> {
	...
	public static void addLocalizedWarn(String message) {
		addWarn(WebdavMessages.getMessage(message));
	}
	...
	public static void addLocalizedError(String message) {
		addError(WebdavMessages.getMessage(message));
	}

	public static void addLocalizedError(String message, String id) {
		addError(WebdavMessages.getMessage(message), id);
	}
	...
	public static void addLocalizedInfo(String message) {
		addInfo(WebdavMessages.getMessage(message));
	}

	public static void addLocalizedInfo(String message, Object[] parameters) {
		addInfo(WebdavMessages.getMessage(message, parameters));
	}
	...
	public String get(Object key) {
		return WebdavMessages.getMessage(key.toString());
	}
}
