...
INSERT INTO co_menus VALUES(1,'db.home',0,1,'home.png','',0,0,NULL,0);
INSERT INTO co_menus VALUES(2,'db.admin',1,1,'administration.png','ROOT',1,1,NULL,0);
INSERT INTO co_menus VALUES(4,'db.personal',1,3,'personal.png','ROOT',1,1,NULL,0);
INSERT INTO co_menus VALUES(5,'db.projects',1,4,'documents.png','ROOT',1,1,'document/browse',0);
INSERT INTO co_menus VALUES(6,'db.user',2,1,'user.png','ROOT/2',1,2,'admin/users',0);
INSERT INTO co_menus VALUES(7,'db.group',2,2,'group.png','ROOT/2',1,2,'admin/groups',0);
INSERT INTO co_menus VALUES(8,'db.logging',2,3,'logging.png','ROOT/2',1,2,'admin/logs',0);
INSERT INTO co_menus VALUES(13,'db.messages',4,1,'message.png','ROOT/4',1,2,'communication/messages',0);
INSERT INTO co_menus VALUES(16,'db.changepassword',4,3,'password.png','ROOT/4',1,2,'settings/password',0);
INSERT INTO co_menus VALUES(17,'directory',2,5,'open.png','ROOT/2',1,2,'admin/folders',0);
INSERT INTO co_menus VALUES(19,'db.editme',4,4,'user.png','ROOT/4',1,2,'settings/personalData',0);
INSERT INTO co_menus VALUES(20,'db.emails',2,4,'mail.png','ROOT/2',1,2,NULL,0);
INSERT INTO co_menus VALUES(23,'smtp',20,3,'mail_preferences.png','ROOT/2/20',1,3,'admin/smtp',0);
INSERT INTO co_menus VALUES(24,'db.emailaccounts',20,4,'mailbox.png','ROOT/2/20',1,3,'admin/accounts',0);
INSERT INTO co_menus VALUES(25,'db.searchengine',2,6,'search.png','ROOT/2',1,2,'admin/searchEngine',0);
INSERT INTO co_menus VALUES(26,'db.keywords',1,5,'keywords.png','ROOT',1,1,'search/keywords',0);
INSERT INTO co_menus VALUES(27,'db.backup',2,7,'backup.png','ROOT/2',1,2,'admin/backup',0);
INSERT INTO co_menus VALUES(14,'task.tasks',2,8,'thread.png','ROOT/2',1,2,'admin/tasks',0);
...
PRIMARY KEY(co_messageid),
FOREIGN KEY(co_username) REFERENCES co_users(co_username),
FOREIGN KEY(co_accountid) REFERENCES co_account(co_accountid) on delete cascade
);
...
INSERT INTO co_menugroup VALUES(14,'admin',0);
