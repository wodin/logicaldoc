...
/**
 * Lets you check JSF phases (for debugging purpose only).
 * To activate, add:
 *    <lifecycle>
 *      <phase-listener>com.logicaldoc.web.util.PhaseTracker</phase-listener>
 *    </lifecycle>
...
public class PhaseTracker
    ...
    public PhaseId getPhaseId() {
        ...
        if (phase == null) {
            ...
            phase = (String) context.getExternalContext()
                .getInitParameter(PHASE_PARAMETER);
        }
