...
/**
 * Particular implementation of the plugin registry for the Tomcat servlet container
 *
...
public class PluginRegistry extends com.logicaldoc.util.PluginRegistry {
    protected void initPlugins(Map<String, Identity> plugins) {
        ...
        while (iterator.hasNext()) {
            ...
            System.out.println("plugin located: " + pluginDescriptor.getId() +
