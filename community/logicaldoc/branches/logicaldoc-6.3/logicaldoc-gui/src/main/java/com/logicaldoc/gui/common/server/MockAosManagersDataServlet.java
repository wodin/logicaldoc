...
public class MockAosManagersDataServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException,
			IOException {
		System.out.println("*** Data aos user managers");
		...
		// Add 15 dummy aosmanagers
		for (int i = 0; i < 15; i++) {
			writer.print("<aosmanager>");
			writer.print("<id>" + i + "</id>");
			writer.print("<username>Aos User Manager " + i + "</username>");
