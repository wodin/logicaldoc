...
public class AddTemplateAttributeDialog extends Window {
	private AttributeSetServiceAsync setService = (AttributeSetServiceAsync) GWT.create(AttributeSetService.class);
	...
	protected void fillSetAttributesList(Long setId) {
		setService.getAttributeSet(setId, new AsyncCallback<GUIAttributeSet>() {
