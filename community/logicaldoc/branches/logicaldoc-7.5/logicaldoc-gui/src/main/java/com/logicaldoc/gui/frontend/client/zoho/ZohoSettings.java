...
public class ZohoSettings extends Window {
	...
	protected ZohoServiceAsync service = (ZohoServiceAsync) GWT.create(ZohoService.class);
	...
	public ZohoSettings() {
		...
		service.loadAuthToken(new AsyncCallback<String>() {
	...
	public void onAuthenticate() {
		service.saveAuthToken(form.getValueAsString("authtoken"), new AsyncCallback<Void>() {
			@Override
			public void onFailure(Throwable caught) {
				Log.serverError(caught);
			}
