insert into ld_menu (ld_id,ld_lastmodified,ld_deleted,ld_text,ld_parentid,ld_icon,ld_type,ld_tenantid,ld_recordversion)
values (-2070,CURRENT_TIMESTAMP,0,'dropbox',5,'document.png',1,1,1);
