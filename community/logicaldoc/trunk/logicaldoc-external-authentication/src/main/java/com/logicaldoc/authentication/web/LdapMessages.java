 ...
 * @since 4.5
 */
public class LdapMessages extends AbstractMap<String, String> {
	/**
	...
	public static void addLocalizedWarn(String message) {
		addWarn(LdapMessages.getMessage(message));
	}
	...
	public static void addLocalizedError(String message) {
		addError(LdapMessages.getMessage(message));
	}

	public static void addLocalizedError(String message, String id) {
		addError(LdapMessages.getMessage(message), id);
	}
	...
	public static void addLocalizedInfo(String message) {
		addInfo(LdapMessages.getMessage(message));
	}

	public static void addLocalizedInfo(String message, Object[] parameters) {
		addInfo(LdapMessages.getMessage(message, parameters));
	}
	...
	public String get(Object key) {
		return LdapMessages.getMessage(key.toString());
	}
}
