 ...
 *
 */
public abstract class LDAPAuthenticationComponent implements ForeignSystemComponent{
	...
	public boolean authenticate(String name, String password) {
		...
		//check whether in the meantime between two checks the user account has been deleted
		if(ldapUser == null)
			return false;
	...
	public void setLdapUserGroupContext(
			LDAPUserGroupContext ldapUserGroupContext) {
