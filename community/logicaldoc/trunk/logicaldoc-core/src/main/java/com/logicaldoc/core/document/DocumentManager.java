...
public interface DocumentManager {
	 ...
	 * @throws Exception if an error occurs, this exception is thrown
	 */
	void checkin(int docId, File file, String filename, String username, VERSION_TYPE versionType, String versionDesc)
			throws Exception;
	 ...
	 * @param username
	 * @param parent
	 * @param name The document name, if null the file name is used
	 * @param file
	 * @param sourceDate
	 * @param source
	 * @param sourceAuthor
	 ...
	 * @param username
	 * @param language
	 * @param name The document name, if null the filename is used
	 * @param sourceDate
	 * @param source
	 * @param sourceAuthor
	 * @param sourceType
