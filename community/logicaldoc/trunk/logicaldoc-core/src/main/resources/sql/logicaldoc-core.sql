...
create table ld_document (ld_id bigint not null, ld_lastmodified timestamp not null, ld_deleted int not null,ld_immutable int not null, ld_customid varchar(4000), ld_title varchar(255), ld_version varchar(10), ld_date timestamp, ld_creation timestamp not null, ld_publisher varchar(255),ld_publisherid bigint not null, ld_status int, ld_type varchar(255), ld_checkoutuserid bigint, ld_source varchar(255), ld_sourceauthor varchar(255), ld_sourcedate timestamp, ld_sourcetype varchar(255), ld_coverage varchar(255), ld_language varchar(10), ld_filename varchar(255), ld_filesize bigint, ld_indexed int not null , ld_folderid bigint, ld_templateid bigint, ld_sourceid varchar(4000), ld_object varchar(4000), ld_digest varchar(255), ld_recipient varchar(4000),  primary key (ld_id));
