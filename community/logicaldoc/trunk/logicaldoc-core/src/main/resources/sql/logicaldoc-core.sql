create table ld_article (ld_id bigint not null, ld_lastmodified timestamp not null, ld_deleted int not null, ld_docid bigint not null, ld_subject varchar(255) not null, ld_message varchar(2000), ld_date timestamp, ld_userid bigint not null, ld_username varchar(255) not null, primary key (ld_id));
