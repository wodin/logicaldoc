...
create table ld_template (ld_id bigint not null, ld_lastmodified timestamp not null, ld_deleted int not null, ld_name varchar(255) not null, ld_description varchar(2000), ld_readonly int not null, primary key (ld_id));
...
create table ld_workflowhistory (ld_id bigint not null, ld_lastmodified timestamp not null, primary key (ld_id));
