...
create table ld_menu (ld_id bigint not null, ld_lastmodified timestamp not null, ld_text varchar(255), ld_parentid bigint, ld_sort int, ld_icon varchar(255), ld_path varchar(255), ld_type int, ld_ref varchar(255), ld_size bigint, primary key (ld_id));
...
create table ld_user (ld_id bigint not null, ld_lastmodified timestamp not null, ld_username varchar(255) not null, ld_password varchar(255), ld_name varchar(255), ld_firstname varchar(255), ld_street varchar(255), ld_postalcode varchar(255), ld_city varchar(255), ld_country varchar(30), ld_language varchar(10), ld_email varchar(255), ld_telephone varchar(255), primary key (ld_id));
...
values     (1,'2008-10-22','admin','Group of admins');

insert into ld_group
values     (2,'2008-10-22','author','Group of authors');

insert into ld_group
values     (3,'2008-10-22','guest','Group of guest');

insert into ld_user
           (ld_id,ld_lastmodified,ld_username,ld_password,ld_name,ld_firstname,ld_street,ld_postalcode,ld_city,ld_country,ld_language,ld_email,ld_telephone)
values     (1,'2008-10-22','admin','d033e22ae348aeb566fc214aec3585c4da997','Admin','Admin','','','','','en','admin@admin.net','');
