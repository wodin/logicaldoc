...
public class AnalyzeFileTest extends TestCase {
    ...
    public AnalyzeFileTest() {
        sbitAnal =  new SnowballAnalyzer("Italian", Stopwords.getStopwords("it"));
    }
    ...
    public void testSnowballAnalyzer() throws Exception  {
        ...
        File file = new File(URLDecoder.decode(getClass().getClassLoader().getResource("AnalyzeFileTest_enc.txt").getPath(),"UTF-8"));
