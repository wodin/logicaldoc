...
values     (3,6,'2010-04-02',0,0,'c','DELETED 1','testDocVer1','2006-12-19','2006-12-19','myself',1,1,'PDF',3,'source2','sourceauthor','2008-12-19','sourcetype','coverage','en','pluto',122345,1,0,'',1,0,1,0);
...
insert into ld_template (ld_id, ld_lastmodified,ld_deleted, ld_name, ld_description, ld_readonly, ld_type, ld_category)
values (1, '2008-11-07',0,'test1','test1_desc',0,0,0);
...
insert into ld_template (ld_id, ld_lastmodified,ld_deleted, ld_name, ld_description, ld_readonly, ld_type, ld_category)
values (2, '2008-11-07',0,'test2','test2_desc',0,0,0);
