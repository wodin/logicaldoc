...
values (6,CURRENT_TIMESTAMP,0,'folder6',5,1,0,1,1);
insert into ld_folder (ld_id,ld_lastmodified,ld_deleted,ld_name,ld_parentid,ld_type,ld_templocked,ld_tenantid,ld_recordversion)
values (7,CURRENT_TIMESTAMP,0,'folder7',5,1,0,1,1);
insert into ld_folder (ld_id,ld_lastmodified,ld_deleted,ld_name,ld_parentid,ld_type,ld_templocked,ld_tenantid,ld_recordversion)
values (8,CURRENT_TIMESTAMP,1,'folder8',7,1,0,1,1);
insert into ld_folder (ld_id,ld_lastmodified,ld_deleted,ld_name,ld_parentid,ld_type,ld_templocked,ld_tenantid,ld_recordversion)
values (1200,CURRENT_TIMESTAMP,0,'test',5,1,0,1,1);
insert into ld_folder (ld_id,ld_lastmodified,ld_deleted,ld_name,ld_parentid,ld_type,ld_templocked,ld_tenantid,ld_recordversion)
values (1201,CURRENT_TIMESTAMP,0,'ABC',1200,1,0,1,1);
insert into ld_folder (ld_id,ld_lastmodified,ld_deleted,ld_name,ld_parentid,ld_type,ld_templocked,ld_tenantid,ld_recordversion)
values (1202,CURRENT_TIMESTAMP,0,'xyz',1201,1,0,1,1);
insert into ld_folder (ld_id,ld_lastmodified,ld_deleted,ld_name,ld_parentid,ld_type,ld_templocked,ld_tenantid,ld_recordversion)
values (1204,CURRENT_TIMESTAMP,1,'deleted',1201,1,0,1,1);
...
values     (1,5,'2008-10-22 00:00:00',0,0,'a','testDocname','1.0','2006-12-19 00:00:00','2006-12-19 00:00:00','myself',1,0,'PDF',3,'source','sourceauthor','2008-12-19 00:00:00','sourcetype','coverage','en','pippo',1356,1,0,'',1,0,0,1,1,1);

insert into ld_document
           (ld_id,ld_folderid,ld_docref,ld_lastmodified,ld_deleted,ld_immutable,ld_customid,ld_title,ld_version,ld_date,ld_creation,ld_publisher,ld_publisherid,ld_status,ld_type,ld_lockuserid,ld_source,ld_sourceauthor,ld_sourcedate,ld_sourcetype,ld_coverage,ld_language,ld_filename,ld_filesize,ld_indexed,ld_signed,ld_creator,ld_creatorid,ld_exportstatus,ld_barcoded,ld_published,ld_tenantid,ld_recordversion)
values     (2,5,1,'2008-10-22 00:00:00',0,0,'b','testDocname2','testDocVer','2006-12-19 00:00:00','2006-12-19 00:00:00','myself',1,0,'PDF',3,'source','sourceauthor','2008-12-19 00:00:00','sourcetype','coverage','en','pippo',1356,0,0,'',1,0,0,1,1,1);

insert into ld_document
           (ld_id,ld_folderid,ld_lastmodified,ld_deleted,ld_immutable,ld_customid,ld_title,ld_version,ld_date,ld_creation,ld_publisher,ld_publisherid,ld_status,ld_type,ld_lockuserid,ld_source,ld_sourceauthor,ld_sourcedate,ld_sourcetype,ld_coverage,ld_language,ld_filename,ld_filesize,ld_indexed,ld_signed,ld_creator,ld_creatorid,ld_exportstatus,ld_barcoded,ld_published,ld_tenantid,ld_recordversion)
values     (3,5,'2008-10-22 00:00:00',0,0,'c','testDocname3','1.1','2006-12-19 00:00:00','2006-12-19 00:00:00','myself',1,0,'PDF',3,'source','sourceauthor','2008-12-19 00:00:00','sourcetype','coverage','en','pippo',1356,1,0,'',1,0,0,1,1,1);

insert into ld_document
           (ld_id,ld_folderid,ld_lastmodified,ld_deleted,ld_immutable,ld_customid,ld_title,ld_version,ld_date,ld_creation,ld_publisher,ld_publisherid,ld_status,ld_type,ld_lockuserid,ld_source,ld_sourceauthor,ld_sourcedate,ld_sourcetype,ld_coverage,ld_language,ld_filename,ld_filesize,ld_indexed,ld_signed,ld_creator,ld_creatorid,ld_exportstatus,ld_barcoded,ld_published,ld_tenantid,ld_recordversion)
values     (4,5,'2008-10-22 00:00:00',0,0,'d','testDocname4','testDocVer','2006-12-19 00:00:00','2006-12-19 00:00:00','myself',1,0,'PDF',3,'source','sourceauthor','2008-12-19 00:00:00','sourcetype','coverage','en','pippo',1356,1,0,'',1,0,0,1,1,1);
...
values     (-1,'2008-10-22 00:00:00',0,1,5,1,'2006-12-20 00:00:00','author','data test 01','reason test 01','1.0',0,1,1,1);

insert into ld_history 
			    (ld_id, ld_lastmodified, ld_deleted, ld_docid, ld_folderid, ld_userid, ld_date, ld_username, ld_event, ld_comment, ld_version, ld_notified, ld_new,ld_tenantid,ld_recordversion)
values     (-2,'2008-10-22 00:00:00',0,2,5,1,'2006-12-25 00:00:00','author','data test 01','reason test 02','1.0',0,1,1,1);
