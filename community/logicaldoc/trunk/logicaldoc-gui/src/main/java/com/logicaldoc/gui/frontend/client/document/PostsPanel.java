...
import com.logicaldoc.gui.frontend.client.data.PostsDS;
...
public class PostsPanel extends DocumentDetailTab {
	...
	public PostsPanel(GUIDocument document, final long discussionId, final Discussion discussion) {
		...
		ListGridField user = new ListGridField("user", I18N.getMessage("by"), 100);
		...
		ListGridField message = new ListGridField("message", I18N.getMessage("message"), 400);
		...
		Button backToDiscussions = new Button("<< " + I18N.getMessage("back"));
		...
		listGrid.addCellContextClickHandler(new CellContextClickHandler() {
			...
			public void onCellContextClick(CellContextClickEvent event) {
				...
				replyItem.setTitle(I18N.getMessage("reply"));
