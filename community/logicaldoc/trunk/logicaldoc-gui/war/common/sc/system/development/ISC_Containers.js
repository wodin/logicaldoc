...
else isc._preLog=[isc._pTM]}isc.ClassFactory.defineClass("ImgTab","StretchImgButton");isc.A=isc.ImgTab.getPrototype();isc.A.capSize=2;isc.A.skinImgDir="images/Tab/";isc.A.labelSkinImgDir="images/";isc.A.baseStyle="tab";isc.A.src="[SKIN]tab.gif";isc.A.showRollOver=false;isc.A.showFocused=true;isc.A.actionType=isc.Button.RADIO;isc.A.mozOutlineOffset="0px";isc.A=isc.ImgTab.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.setPane=function(_1){this.parentElement.parentElement.updateTab(this,_1)}
,isc.A.selectTab=function(){this.parentElement.parentElement.selectTab(this)}
,isc.A.initWidget=function(_1,_2,_3,_4,_5,_6){if(this.vertical&&this.titleStyle)this.titleStyle="v"+this.titleStyle;return this.invokeSuper(isc.ImgTab,this.$oc,_1,_2,_3,_4,_5,_6)}
...
_3.overflow=isc.Canvas.VISIBLE;_3.vertical=(this.tabBarPosition==isc.Canvas.LEFT||this.tabBarPosition==isc.Canvas.RIGHT);_3.skinImgDir=this.buttonConstructor.getInstanceProperty("skinImgDir")+this.tabBarPosition+"/";_3.iconClick=this.$42k;_3._generated=true;var _4=this.tabBarPosition+"StyleName";if(this[_4])this.setStyleName(this[_4]);this.Super(this.$oc);if(this._baseLine==null)this.makeBaseLine()}
...
,isc.A.makeButton=function(_1,_2,_3,_4,_5){var _6=this.parentElement.canCloseTab(_1);isc.addProperties(_1,this.getCloseIconProperties(_1));return this.invokeSuper("TabBar","makeButton",_1,_2,_3,_4,_5)}
,isc.A.getCloseIconProperties=function(_1){var _2={};if(!_1.canClose){_2.icon=(_1.icon);_2.iconSize=(_1.iconSize);_2.iconOrientation=_1.iconOrientation;_2.iconAlign=_1.iconAlign}else{_2.icon=(_1.closeIcon||this.parentElement.closeTabIcon);_2.iconSize=(_1.closeIconSize||this.parentElement.closeTabIconSize);_2.iconOrientation=isc.Page.isRTL()?"left":"right";_2.iconAlign=_2.iconOrientation}
return _2}
...
,isc.A.setButtons=function(_1){this.logWarn("Window.setButtons() method called. This has been deprecated in "+"favor of Window.setToolbarButtons()","deprecated");return this.setToolbarButtons(_1)}
,isc.A.setToolbarButtons=function(_1){this.toolbarButtons=_1;if(this.toolbar)this.toolbar.setButtons(_1)}
,isc.A.makeFooter=function(){if(!this.showFooter)return;this.addAutoChild("footer",{height:this.footerHeight});if(!this.footer)return;var _1=[];for(var i=0;i<this.footerControls.length;i++){var _3=this.footerControls[i],_4={};if(_3=="spacer")_3=isc.LayoutSpacer.create();if(_3=="resizer"){if(!this.canDragResize)continue;_4.dragTarget=this}
...
,isc.A.setStatus=function(_1){this.status=_1;if(this.statusBar==null)return;if(_1==null)_1="";var _2=(this.statusBar.leftPadding?isc.Canvas.spacerHTML(this.statusBar.leftPadding,1):"");this.statusBar.setContents(_2+_1)}
...
,isc.A.handleEscape=function(){if(this.isMasked())return;this.handleCloseClick()}
...
,isc.A.centerInPage=function(){var _1=this.getVisibleWidth(),_2=this.getVisibleHeight(),_3=this.parentElement?this.parentElement:isc.Page,_4=((_3.getWidth()-_1)/2)+_3.getScrollLeft(),_5=((_3.getHeight()-_2)/2)+_3.getScrollTop();_4=Math.round(_4);_5=Math.max(Math.round(_5),0);this.$7j=true;this.moveTo(_4,_5);this.$7j=null}
...
,isc.A.$7e=function(){return this.handleCloseClick()}
,isc.A.handleCloseClick=function(){if(this.onCloseClick&&this.onCloseClick()==false)return;return this.closeClick()}
,isc.A.closeClick=function(){this.returnValue(null);this.hide();return false}
);isc.B._maxIndex=isc.C+71;isc.Window.registerStringMethods({onMaximizeClick:"",onMinimizeClick:"",onRestoreClick:"",onCloseClick:""})
if(isc.definePrintWindow)isc.definePrintWindow();isc.defineClass("Portlet","Window");isc.A=isc.Portlet.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.showShadow=false;isc.A.animateMinimize=true;isc.A.dragAppearance="outline";isc.A.canDrop=true;isc.A.dragType="Portlet";isc.A.resizeFrom=null;isc.A.showMaximizeButton=true;isc.A.headerControls=["headerLabel","minimizeButton","maximizeButton","closeButton"];isc.A.dragOpacity=30;isc.A.showCloseConfirmationMessage=true;isc.A.closeConfirmationMessage="Close portlet?";isc.B.push(isc.A.closeClick=function(){if(this.showCloseConfirmationMessage){isc.confirm(this.closeConfirmationMessage,{target:this,methodName:"confirmedClosePortlet"})}else{this.confirmedClosePortlet(true)}}
,isc.A.confirmedClosePortlet=function(_1){if(!_1)return;var _2=this.parentElement,_3=_2?_2.parentElement:null,_4=_3?_3.parentElement:null;if(!isc.isA.PortalLayout(_4))this.clear();else _4.removePortlet(this)}
...
,isc.A.membersChanged=function(){if(this.members.length==0&&!this.portletMaximizing)this.destroy()}
);isc.B._maxIndex=isc.C+5;isc.defineClass("PortalColumn","Layout");isc.A=isc.PortalColumn.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.vertical=true;isc.A.defaultResizeBars="marked";isc.A.layoutMargin=3;isc.A.dragAppearance="outline";isc.A.canAcceptDrop=true;isc.A.canDrop=true;isc.A.dragType="PortalColumn";isc.A.dropTypes=["Portlet"];isc.A.dropLineThickness=2;isc.A.dropLineProperties={backgroundColor:"blue"};isc.A.showColumnHeader=true;isc.A.rowConstructor="PortalRow";isc.B.push(isc.A.initWidget=function(){this.Super("initWidget",arguments);if(this.showColumnHeader){this.columnHeader=isc.PortalColumnHeader.create({title:"Column",portalColumn:this});this.addMember(this.columnHeader)}}
,isc.A.addNewColumn=function(){this.portalLayout.addColumnAfter(this)}
,isc.A.getDropComponent=function(_1,_2){this.addPortlet(_1,this.getDropPosition())}
,isc.A.addPortlet=function(_1,_2){if(this.showColumnHeader)_2+=1;var _3=this.getMembers();if(_3==null)_2=0;else if(_2>_3.length)_2=_3.length;var _4=_1.$po;if(_4!=null){_1.setHeight("100%")}
var _5={showResizeBar:this.canResizeRows};if(_4!=null){_5.height=_4}
var _6=this.createAutoChild("row",_5);this.addMember(_6,_2);_6.addMember(_1)}
,isc.A.getDropPosition=function(){var _1=this.Super("getDropPosition",arguments);if(_1==0)_1=1;return _1}
);isc.B._maxIndex=isc.C+5;isc.defineClass("PortalLayout","Layout");isc.A=isc.PortalLayout.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.vertical=false;isc.A.numColumns=2;isc.A.showColumnMenus=true;isc.A.columnBorder="1px solid gray";isc.A.canResizeColumns=false;isc.A.canResizeRows=false;isc.A.canAcceptDrop=true;isc.A.dropTypes=["PortalColumn"];isc.A.dropLineThickness=2;isc.A.dropLineProperties={backgroundColor:"blue"};isc.A.columnConstructor="PortalColumn";isc.B.push(isc.A.getNumColumns=function(){return this.getMembers().length}
,isc.A.setColumnBorder=function(_1){this.columnBorder=_1;var _2=this.members||[];for(var i=0;i<_2.length;i++){_2[i].setBorder(_1)}}
,isc.A.initWidget=function(){this.Super("initWidget",arguments);for(var i=0;i<this.numColumns;i++)this.addMember(this.makePortalColumn())}
,isc.A.makePortalColumn=function(_1){if(_1==null)_1={};isc.addProperties(_1,{portalLayout:this,showColumnHeader:this.showColumnMenus,border:this.columnBorder,showResizeBar:this.canResizeColumns,canResizeRows:this.canResizeRows});var _2=this.createAutoChild("column",_1);return _2}
,isc.A.addColumn=function(_1){this.addMember(this.makePortalColumn({}),_1)}
,isc.A.removeColumn=function(_1){var _2=this.members[_1];if(_2!=null)_2.destroy()}
,isc.A.addColumnAfter=function(_1){var _2=this.getMemberNumber(_1)+1;this.addColumn(_2)}
,isc.A.addPortlet=function(_1,_2,_3){if(_3==null)_3=0;if(_2==null)_2=0;var _4=this.getMember(_2);if(_4!=null)_4.addPortlet(_1,_3)}
,isc.A.removePortlet=function(_1){if(!this.contains(_1))return;_1.deparent()}
);isc.B._maxIndex=isc.C+9;isc.defineClass("EditModePortalRow","PortalRow");isc.ClassFactory.mixInInterface("EditModePortalRow","EditContext");isc.A=isc.EditModePortalRow.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getDropComponent=function(_1,_2){if(!isc.isA.Palette(_1))return _1;var _3=_1.transferDragData(),_4=(isc.isAn.Array(_3)?_3[0]:_3);var _5=isc.Portlet.create({autoDraw:false,title:_4.title,items:[_4.liveObject],confirmedClosePortlet:function(_6){this.Super("closePortlet",arguments);if(_6)this.destroy()}});return _5}
);isc.B._maxIndex=isc.C+1;isc.defineClass("EditModePortalColumn","PortalColumn");isc.ClassFactory.mixInInterface("EditModePortalColumn","EditContext");isc.A=isc.EditModePortalColumn.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.rowConstructor="EditModePortalRow";isc.B.push(isc.A.getDropComponent=function(_1,_2){var _3;if(!isc.isA.Palette(_1))_3=_1;else{var _4=_1.transferDragData(),_5=(isc.isAn.Array(_4)?_4[0]:_4);var _6=isc.Portlet.create({autoDraw:false,title:_5.title,items:[_5.liveObject],confirmedClosePortlet:function(_7){this.Super("closePortlet",arguments);if(_7)this.destroy()}});_3=_6}
this.addPortlet(_3,this.getDropPosition())}
);isc.B._maxIndex=isc.C+1;isc.A=isc.PortalLayout.getPrototype();isc.A.columnConstructor="EditModePortalColumn";isc.ClassFactory.defineClass("Dialog","Window");isc.A=isc.Dialog;isc.A.$76=[];isc.A.OK_BUTTON_TITLE="OK";isc.A.APPLY_BUTTON_TITLE="Apply";isc.A.YES_BUTTON_TITLE="Yes";isc.A.NO_BUTTON_TITLE="No";isc.A.CANCEL_BUTTON_TITLE="Cancel";isc.A.DONE_BUTTON_TITLE="Done";isc.A.CONFIRM_TITLE="Confirm";isc.A.SAY_TITLE="Note";isc.A.WARN_TITLE="Note";isc.A.ASK_TITLE="Question";isc.A.ASK_FOR_VALUE_TITLE="Please enter a value";isc.A.LOGIN_TITLE="Please log in";isc.A.USERNAME_TITLE="Username";isc.A.PASSWORD_TITLE="Password";isc.A.LOGIN_BUTTON_TITLE="Log in";isc.A.LOGIN_ERROR_MESSAGE="Invalid username or password";isc.A.OK={getTitle:function(){return isc.Dialog.OK_BUTTON_TITLE},width:75,click:function(){this.topElement.okClick()}};isc.A.APPLY={getTitle:function(){return isc.Dialog.APPLY_BUTTON_TITLE},width:75,click:function(){this.topElement.applyClick()}};isc.A.YES={getTitle:function(){return isc.Dialog.YES_BUTTON_TITLE},width:75,click:function(){this.topElement.yesClick()}};isc.A.NO={getTitle:function(){return isc.Dialog.NO_BUTTON_TITLE},width:75,click:function(){this.topElement.noClick()}};isc.A.CANCEL={getTitle:function(){return isc.Dialog.CANCEL_BUTTON_TITLE},width:75,click:function(){this.topElement.cancelClick()}};isc.A.DONE={getTitle:function(){return isc.Dialog.DONE_BUTTON_TITLE},width:75,click:function(){this.topElement.doneClick()}};isc.A=isc.Dialog.getPrototype();isc.A.styleName="dialogBackground";isc.A.skinImgDir="images/Dialog/";isc.A.canDragReposition=false;isc.A.canDragResize=false;isc.A.autoCenter=true;isc.A.bodyStyle="dialogBody";isc.A.bodyColor="#DDDDDD";isc.A.hiliteBodyColor="#FFFFFF";isc.A.messageStyle="normal";isc.A.headerStyle="dialogHeader";isc.A.hiliteHeaderStyle="dialogHeaderHilite";isc.A.headerLabelDefaults=isc.addProperties({},isc.Window.getInstanceProperty("headerLabelDefaults"),{styleName:"dialogHeaderText"});isc.A.showHeaderIcon=false;isc.A.showMinimizeButton=false;isc.A.showMaximizeButton=false;isc.A.showFooter=false;isc.A.showToolbar=true;isc.A.askIcon="[SKIN]ask.png";isc.A.sayIcon="[SKIN]say.png";isc.A.warnIcon="[SKIN]warn.png";isc.A.confirmIcon="[SKIN]confirm.png";isc.A.notifyIcon="[SKIN]notify.png";isc.A.errorIcon="[SKIN]error.png";isc.A.stopIcon="[SKIN]stop.png";isc.A=isc.Dialog.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.saveData=function(){}
...
isc.ClassFactory.defineClass("LoginDialog","Window");isc.LoginDialog.registerStringMethods({register:"values, form",lostPassword:"values, form"});isc.A=isc.LoginDialog.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.dismissable=false;isc.A.allowBlankPassword=false;isc.A.showLostPasswordLink=false;isc.A.showRegistrationLink=false;isc.A.title=isc.Dialog.LOGIN_TITLE;isc.A.errorStyle="formCellError";isc.A.usernameItemTitle=isc.Dialog.USERNAME_TITLE;isc.A.passwordItemTitle=isc.Dialog.PASSWORD_TITLE;isc.A.loginButtonTitle=isc.Dialog.LOGIN_BUTTON_TITLE;isc.A.lostPasswordItemTitle="Lost Password?";isc.A.registrationItemTitle="Register";isc.A.errorMessage=isc.Dialog.LOGIN_ERROR_MESSAGE;isc.A.autoCenter=true;isc.A.autoSize=true;isc.A.isModal=true;isc.A.showMinimizeButton=false;isc.A.items=["autoChild:loginForm"];isc.A.loginFormConstructor="DynamicForm";isc.A.loginFormDefaults={numCols:2,padding:4,autoDraw:false,saveOnEnter:true,submit:function(){var _1=this,_2=[{username:this.getValue("usernameItem"),password:this.getValue("passwordItem")}];_2[1]=function(_3,_4){if(_3){_1.complete()}else{if(_4!=null)
_1.setValue("loginFailureItem",_4)
_1.showItem("loginFailureItem");_1.focusInItem("passwordItem")}};this.fireCallback(this.loginDialog.loginFunc,"credentials,dialogCallback",_2)},complete:function(_1){this.loginDialog.hide();this.setValue("loginFailureItem",this.loginDialog.errorMessage);this.setValue("usernameItem","");this.setValue("passwordItem","");this.hideItem("loginFailureItem");if(_1){this.fireCallback(this.loginFunc,"credentials,dialogCallback")}else{var _2=isc.Cookie.get("loginRedirect");if(_2)window.location.replace(_2)}}};isc.A.formDSDefaults={clientOnly:true,useAllDataSourceFields:true};isc.A.formDefaultFields=[{name:"loginFailureItem",type:"blurb",colSpan:2,visible:false},{name:"usernameItem",required:true,keyPress:function(_1,_2,_3){if(_3=="Enter"){_2.focusInItem("passwordItem");return false}}},{name:"passwordItem",type:"password",required:true},{name:"loginButton",type:"button",type:"submit"},{name:"lostPasswordItem",type:"link",target:"javascript",canEdit:false,endRow:true,numCols:2,colSpan:2,showTitle:false,click:"form.loginDialog.lostPassword(form.getValues(), form)"},{name:"registrationItem",type:"link",target:"javascript",canEdit:false,endRow:true,numCols:2,colSpan:2,showTitle:false,click:"form.loginDialog.register(form.getValues(), form)"}];isc.B.push(isc.A.getDynamicDefaults=function(_1){switch(_1){case"loginForm":var _2={loginDialog:this,values:{usernameItem:this.username||"",passwordItem:this.password||"",loginFailureItem:this.errorMessage},fields:this.formFields};var _3=isc.clone(this.formDefaultFields);for(var j=0;j<_3.length;j++){var _5=_3[j],_6=_5.name;isc.addProperties(_5,this[_6+"Defaults"],this[_6+"Properties"]);if(null!=this[_6+"Title"]){_5.title=this[_6+"Title"];if(_5.type=='link'&&!_5.showTitle)
...
return null}
,isc.A.cancelClick=function(){this.loginForm.complete(true)}
,isc.A.init=function(){this.dismissOnEscape=this.showCloseButton=this.dismissable;this.Super("init",arguments);this.loginForm.focusInItem("usernameItem");if(this.username)this.loginForm.setValue("usernameItem",this.username);if(this.password)this.loginForm.setValue("passwordItem",this.password)}
...
isc.ClassFactory.defineClass("TabSet","Canvas");isc.A=isc.TabSet.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.overflow="hidden";isc.A.tabProperties={};isc.A.simpleTabBaseStyle="tabButton";isc.A.tabBarPosition=isc.Canvas.TOP;isc.A.tabBarThickness=21;isc.A.selectedTab=0;isc.A.closeTabIcon="[SKIN]/TabSet/close.png";isc.A.closeTabIconSize=16;isc.A.tabBarControls=["tabScroller","tabPicker"];isc.A.showTabScroller=true;isc.A.showTabPicker=true;isc.A.tabBarControlLayoutConstructor="Layout";isc.A.tabBarControlLayoutDefaults={};isc.A.animateTabScrolling=true;isc.A.scrollerButtonSize=16;isc.A.pickerButtonSize=16;isc.A.skinImgDir="images/TabSet/";isc.A.symmetricScroller=true;isc.A.scrollerSrc="[SKIN]/scroll.gif";isc.A.scrollerHSrc="[SKIN]hscroll.gif";isc.A.scrollerVSrc="[SKIN]vscroll.gif";isc.A.symmetricPickerButton=true;isc.A.pickerButtonSrc="[SKIN]/picker.gif";isc.A.pickerButtonHSrc="[SKIN]hpicker.gif";isc.A.pickerButtonVSrc="[SKIN]vpicker.gif";isc.A.paneContainerConstructor="PaneContainer";isc.A.paneContainerClassName="tabSetContainer";isc.A.paneContainerOverflow=isc.Canvas.AUTO;isc.A.symmetricEdges=true;isc.B.push(isc.A.setPaneContainerOverflow=function(_1){this.paneContainerOverflow=_1;if(this.paneContainer)this.paneContainer.setOverflow(_1)}
);isc.B._maxIndex=isc.C+1;isc.A=isc.TabSet.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.tabBarConstructor=isc.TabBar;isc.A.disablePaneWithTab=true;isc.A.$537={top:"topEdgeSizes",bottom:"bottomEdgeSizes",left:"leftEdgeSizes",right:"rightEdgeSizes"};isc.A.$538={top:"topEdgeOffsets",bottom:"bottomEdgeOffsets",left:"leftEdgeOffsets",right:"rightEdgeOffsets"};isc.B.push(isc.A.initWidget=function(){this.showEdges=false;this.Super("initWidget",arguments);if(this.tabs==null)this.tabs=[];if(this.tabBarDefaults==null)this.tabBarDefaults={};this.tabProperties=this.tabProperties||this.tabInstanceDefaults||{};var _1=this.tabBarPosition;if(this.tabBarAlign==null){this.tabBarAlign=((_1=="left"||_1=="right")?"top":"left")}
...
this.parentElement.$8b(_8)},buttonSelected:function(_8){this.Super("buttonSelected",arguments);if(this.parentElement!=null){this.parentElement.$8c(_8)}},childResized:function(){this.Super("childResized",arguments);if(this.parentElement!=null){this.parentElement.$54m()}},tabBarPosition:this.tabBarPosition,tabBarAlign:this.tabBarAlign,autoDraw:false},this.tabBarDefaults,this.tabBarProperties);this.tabBar=this._tabBar=this.tabBarConstructor.create(_7);this.addChild(this._tabBar)}
...
,isc.A.createPanes=function(){for(var i=0;i<this.tabs.length;i++){var _2=this.tabs[i],_3=_2.pane;if(_3==null)continue;_2.pane=this.createPane(_3,_2)}}
,isc.A.createPane=function(_1,_2){if(_1==null)return _1;if(!isc.isA.Canvas(_1))_1=this.createCanvas(_1);if(_1==null)return _1;_1.hide();if(this.disablePaneWithTab&&_2&&_2.disabled){_1.setDisabled(_2.disabled)}
...
,isc.A.setTabDisabled=function(_1,_2){var _3=this.getTabObject(_1);if(_3)_3.disabled=_2;var _1=this.getTab(_1);if(_1){_1.setDisabled(_2);var _4=_1.pane;if(_4&&this.disablePaneWithTab){if(isc.isA.Canvas(_4))_4.setDisabled(_2);else _4.disabled=_2}}
this.resetTabPickerMenu()}
...
,isc.A.setTabPane=function(_1,_2){return this.updateTab(_1,_2)}
...
,isc.A.canCloseTab=function(_1){_1=this.getTabObject(_1);if(_1&&_1.canClose!=null)return _1.canClose;return this.canCloseTabs}
,isc.A.setCanCloseTab=function(_1,_2){_1=this.getTabObject(_1);var _3=this.getTab(_1);_1.canClose=_2;var _4=isc.addProperties({},_1,{canClose:_2});if(_3){_3.setProperties(this.getTabBar().getCloseIconProperties(_4))}}
,isc.A.$52a=function(_1){var _2=this.canCloseTab(_1);if(_2){this.closeClick(_1);return false}else return this.tabIconClick(_1)}
,isc.A.closeClick=function(_1){if(this.onCloseClick&&(this.onCloseClick(_1)==false)){return}
this.removeTab(_1)}
...
var _6=this.getTab(_1);if(_2==null)return _4.pane=_6.pane=null;_2=_4.pane=this.createPane(_2,_4);if(_6!=null)_6.pane=_2;if(!this.isDrawn())return;if(this.getSelectedTabNumber()==_3){if(!this.paneContainer.hasMember(_2))this.paneContainer.addMember(_2);_2.show()}}
...
var _5=this.showControls();if(_5){if(_4)_1.setHeight(this.getViewportHeight()-this.tabBarControlLayout.getHeight());else _1.setWidth(this.getViewportWidth()-this.tabBarControlLayout.getWidth())}else{_1.resizeTo(_4?null:"100%",_4?"100%":null)}
...
this.tabPicker=isc.ImgButton.create({customState:this.symmetricPickerButton?null:this.tabBarPosition,tabSet:this,showRollOver:false,skinImgDir:this.skinImgDir,src:_11,height:(_2?_10:(this.tabBarThickness-this._tabBar.baseLineThickness)),width:(_2?(this.tabBarThickness-this._tabBar.baseLineThickness):_10),click:"this.tabSet.showTabPickerMenu()"},this.tabPickerProperties)}
...
,isc.A.$510=function(){var _1=this.tabBarControlLayout;if(!_1||!_1.isDrawn()||!_1.isVisible())return;var _2=0;for(var i=0;i<_1.members.length;i++){if(_1.vertical)_2+=_1.members[i].getVisibleHeight();else _2+=_1.members[i].getVisibleWidth()}
this.placeControlLayout(_2)}
,isc.A.hideControls=function(){if(this.tabBarControlLayout&&this.tabBarControlLayout.isVisible())this.tabBarControlLayout.hide();if(this.$8g&&this.$8g.isVisible())this.$8g.hide()}
...
this.$8i(_1);var _4=this._tabBar;var _5=this;_4.scrollTabIntoView(_2,null,this.animateTabScrolling,function(){if(isc.isA.Function(_5.tabScrolledIntoView))_5.tabScrolledIntoView()})}
...
);isc.B._maxIndex=isc.C+52;isc.TabSet.registerStringMethods({tabSelected:"tabNum,tabPane,ID,tab",tabDeselected:"tabNum,tabPane,ID,tab",getPaneContainerEdges:"",onCloseClick:"tab"});isc.defineClass("PaneContainer","VLayout");isc.A=isc.PaneContainer.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.handleKeyPress=function(_1,_2){if(_1.keyName=="Tab"&&_1.ctrlKey){var _3=this.parentElement,_4=_3.tabs.length-1,_5=_3.getSelectedTabNumber();if(_1.shiftKey){if(_5>0)_5-=1;else _5=_4}else{if(_5<_4)_5+=1;else _5=0}
