...
,isc.A.verifyImportDataSources=function(){if(this.dsList.getSelection().length==0){isc.say("Please select a DataSource to work with first.");return}
...
,isc.A.importDataSources=function(){var _1=this.dsOptions.getValues();_1.dsList=this.dsList.getSelection().getProperty("dsName").getUniqueItems();var _2={appInputs:_1,prompt:"Importing Datasource[s] - This may take a few minutes."};this.adminConsole.performOperation("importDataSources",null,"isc.say(data)",_2)}
...
,isc.A.browseDatabase=function(){var _1=this.dbList.getSelectedRecord();isc.DatabaseBrowser.create({autoCenter:true,canDragReposition:false,width:"90%",height:"90%",dbName:_1.dbName,closeClick:function(){this.destroy()}}).show()}
,isc.A.downloadServerProperties=function(){var _1="/WEB-INF/classes/server.properties",_2=isc.DataSource.getDataSource("Filesystem"),_3=this;_2.fetchData({path:_1},function(_4){_3.downloadServerPropertiesReply(_4.data)},{operationId:"loadFile"})}
,isc.A.downloadServerPropertiesReply=function(_1){if(isc.isAn.Array(_1))_1=_1[0];isc.DMI.callBuiltin({methodName:"downloadClientContent",arguments:[_1.contents,"server.properties","text"],requestParams:{transport:"hiddenFrame",downloadResult:true,showPrompt:false}})}
