...
,isc.A.createFilter=function(){this.filterForm=isc.AdvancedFilter.create({ID:this.getID()+"$wo",autoDraw:false,dataSource:this.dataSource,dualMode:true,currentMode:"simple",mv:this,filter:function(_1,_2){this.Super("filter",[this.mv.currentDBC,_2])}},this.filterProperties)}
,isc.A.setCurrentView=function(_1,_2){if(_1==null)_1=this.currentView;this.currentView=_1;if(this.currentDBC)this.currentDBC.hide();if(_2){var _3=this.$215[_1]=this.createAutoChild(_1,this.$71z(_1));this.addSwitcher(_3)}else{this.$217(_1)}
this.currentDBC=this.$215[_1];this.addMember(this.currentDBC);this.currentDBC.show();this.showView(this.currentDBC)}
,isc.A.$71z=function(_1){var _2=isc.addProperties({},this.dbcDefaults,this.dbcProperties,{dataSource:this.dataSource,title:this.title,icon:this.icon,multiView:this,showFilterEditor:this.showFilterEditor,autoFetchData:this.autoFetchData,recordClick:this.$71y});return _2}
,isc.A.$217=function(_1){var _2=this.getView(_1);if(!_2){var _2=this.$215[_1]=this.createAutoChild(_1,this.$71z(_1));this.addSwitcher(_2)}
...
,isc.A.updateSortList=function(_1){var _2=_1.getDataSource(),_3=_2?isc.getValues(_2.getFields()):[],_4=_1.panelHeader,_5=_4?_4.controlsLayout.getMembers():[],_6={};for(var i=1;i<_5.length;i++){var _8=_5.get(i);if(_8.actionObject.name=="sort"){for(var i=0;i<_3.length;i++){var _9=_3.get(i);_6[_9.name]=_9.title}
_8.getField("sortField").setValueMap(_6);break}}}
,isc.A.addSwitcher=function(_1){if(!_1.panelHeader)return;_1.panelHeader.controlsLayout.addMember(this.getSwitcherControl(_1),0)}
,isc.A.getSwitcherControl=function(_1){var _2=this,_3=isc.DynamicForm.create({autoDraw:true,multiView:_2,fields:[{name:"switcher",title:"View",type:"select",width:80,defaultValue:_2.currentView,valueMap:this.views,changed:function(_4,_5,_6){_2.setCurrentView(_6)}}]});return _3}
,isc.A.setTitle=function(_1){this.title=_1;var _2=this.currentDBC;if(_2){_2.title=this.title;if(_2.panelHeader){_2.panelHeader.setPanelTitleFromCanvas();_2.panelHeader.redraw()}}}
,isc.A.showView=function(_1){}
,isc.A.getView=function(_1){return this.$215[_1]}
,isc.A.getSelectedRecord=function(){var _1=this.currentDBC;if(_1&&_1.getSelectedRecord)return _1.getSelectedRecord()}
,isc.A.recordClick=function(_1,_2){}
,isc.A.$71y=function(){var _1;if(isc.isA.ListGrid(this))_1=arguments[1];else if(isc.isA.TileGrid(this))_1=arguments[2];return this.multiView.recordClick(_1,this)}
