 ...
 * @since 4.5
 */
public class BrazilianPlugin extends LogicalDOCPlugin {

	protected static Log log = LogFactory.getLog(BrazilianPlugin.class);
	...
	protected void install() throws Exception {
		...
		log.info("Add Brazilian (pt_BR) language to faces-config.xml");
