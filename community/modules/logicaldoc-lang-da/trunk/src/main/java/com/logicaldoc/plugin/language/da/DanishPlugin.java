...
/**
 * Language module plugin class to support Danish.
 * 
 * @author Alessandro Gasparini - Logical Objects
 * @since 5.1.0
 */
public class DanishPlugin extends LogicalDOCPlugin {

	protected static Log log = LogFactory.getLog(DanishPlugin.class);
